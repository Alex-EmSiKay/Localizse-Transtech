...
This application was submitted as a final project for CS50W: Web Programming with Python and JavaScript
...
These are not available in the public repository
...
Starting from a clean database you will need to add the languages and groups (Creator, Reviewer, Auditor) manually in admin. (The most important part here is to use a valid [ISO 639-1 code](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for the languages.)
